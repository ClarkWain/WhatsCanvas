...
- `build\Debug\WhatsCanvasUnicodeBidiConformanceTests.exe tests/unicode --exhaustive`: full Unicode 17.0.0 diagnostic run across `BidiTest.txt` and `BidiCharacterTest.txt`; this currently reports the remaining full UAX #9 gaps for explicit isolate/embedding interactions and paired brackets.
