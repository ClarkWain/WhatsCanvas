...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| whatscanvas | `image_grid` | 0.931 ms [0.921, 0.958] | 1.000x [1.000, 1.000] | 0.000 | 0.000 | 0.000% | PASS |
| nanovg | `image_grid` | 0.448 ms [0.396, 0.473] | 0.471x [0.467, 0.475] | 0.962 / 0.020x | 5.369 / 0.086x | 2.061% | PASS |
