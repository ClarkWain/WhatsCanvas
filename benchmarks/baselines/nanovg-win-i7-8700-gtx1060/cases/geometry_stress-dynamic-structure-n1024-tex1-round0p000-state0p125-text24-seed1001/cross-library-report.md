...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| whatscanvas | `geometry_stress` | 1.730 ms [1.693, 1.970] | 1.000x [1.000, 1.000] | 0.000 | 0.000 | 0.000% | PASS |
| nanovg | `geometry_stress` | 1.906 ms [1.796, 2.153] | 1.089x [1.083, 1.095] | 1.221 | 7.177 | 2.251% | PASS |
