...
function(whatscanvas_add_gl_family_library target_name project_root)
    ...
    set(WHATSCANVAS_VULKAN_BACKEND_AVAILABLE OFF CACHE INTERNAL "True when the configured renderer target compiled real Vulkan support.")
    ...
    if (WHATSCANVAS_ENABLE_VULKAN)
        ...
        if (Vulkan_FOUND)
            ...
            set(WHATSCANVAS_VULKAN_BACKEND_AVAILABLE ON CACHE INTERNAL "True when the configured renderer target compiled real Vulkan support.")
