...
- `GlyphAtlas` 管理 glyph allocation、indexed lookup、dirty rect、context rebuild keys 和 atlas stats；Canvas 侧拥有持久 GPU atlas resource，并支持局部更新、resize-before-evict 和 atlas 文本阴影采样。
