...
The generated API index is maintained in `doc/public/reference/API_REFERENCE.md`.
...
WhatsCanvas `1.2.0` adds `Canvas::drawImageRects` and
...
against matching headers rather than mixing 1.2.0 headers with an older
