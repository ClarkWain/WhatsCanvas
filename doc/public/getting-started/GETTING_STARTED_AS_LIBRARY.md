...
exact public symbols see the [API Reference](../reference/API_REFERENCE.md).
...
- **Want to see what each drawing API produces?** →
  [Visual API Gallery](../reference/visual-api-gallery.md) (real renderer captures, not mockups).
...
| --- | --- | --- |
| Shapes and paint | Paths, anti-aliasing, gradients, clipping, Gaussian shadows | [Open the geometry gallery](../reference/visual-api-gallery.md#composed-geometry) |
| Text and fonts | Fallback, CJK, bidi, wrapping, gradient/stroke text, path text | [Open the text gallery](../reference/visual-api-gallery.md#text-and-fonts) |
| Image filters | Rounded frosted glass, backdrop blur, tint, grain, inner depth | [Open the filter gallery](../reference/visual-api-gallery.md#image-filters-and-frosted-glass) |
...
# e.g. whatscanvas-win64-release-<version>.zip
#      whatscanvas-linux-x64-release-<version>.zip
#      whatscanvas-macos-universal-release-<version>.zip
```
...
simulator slices. Follow the [Android Integration Guide](../platforms/ANDROID_INTEGRATION.md)
or [iOS Build Notes](../platforms/IOS_BUILD_NOTES.md) for host-specific setup. Demo apps are
...
[![Actual WhatsCanvas text rendering output](../images/text-rendering-showcase.png)](../reference/visual-api-gallery.md#text-and-fonts)
...
[![WhatsCanvas linear and radial gradient output](../images/aa/gradient_comparison.png)](../reference/visual-api-gallery.md#gradients)
...
[![WhatsCanvas Gaussian shadows at two blur radii](../images/aa/shadow_comparison.png)](../reference/visual-api-gallery.md#gaussian-shadows)
...
[![WhatsCanvas path clipping combined with gradients](../images/aa/quality_showcase.png)](../reference/visual-api-gallery.md#clipping-and-composed-geometry)
...
[![Actual WhatsCanvas frosted-glass interface output](../images/image-filter-showcase.png)](../reference/visual-api-gallery.md#image-filters-and-frosted-glass)

The capture is a complete 1920 x 1080 WhatsCanvas frame. See
[Image Filters & Frosted Glass](../guides/rendering/IMAGE_FILTERS.md) for content filters, backdrop
...
See `doc/public/validation/VISUAL_REGRESSION.md` for the baseline policy and
`doc/public/reference/API_STABILITY.md` for the public API boundary.

---

## 7. Where to go next

- [API Reference](../reference/API_REFERENCE.md) — every public symbol.
- [API Stability](../reference/API_STABILITY.md) — what is guaranteed stable.
- [Text Feature Matrix](../guides/text/TEXT_FEATURE_MATRIX.md) — text/font capabilities.
- [Vulkan backend status](../backends/vulkan-backend-status.md) — enabling Vulkan.
- [iOS Build Notes](../platforms/IOS_BUILD_NOTES.md) — Metal/GLES integration and Apple-device validation boundaries.
