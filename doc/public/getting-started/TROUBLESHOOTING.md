...
[Shader Portability](../backends/SHADER_PORTABILITY.md#current-rules).
...
and the [Android Spider case study](../performance/ANDROID_INTERACTIVE_PERFORMANCE.md).
...
- Use the exact version: `find_package(WhatsCanvas 1.1.0 CONFIG REQUIRED)`.
...
- Check the [API Reference](../reference/API_REFERENCE.md) and [API Stability](../reference/API_STABILITY.md).
