...
> Archived measurements and completed optimization history. Active work lives
> in `doc/internal/backlog/performance.md`.

> Maintainer document. This backlog is excluded from the published
> documentation; public methodology and verified results live in
