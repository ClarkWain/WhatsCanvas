...
| Security and dependency review | A vulnerability reporting policy exists and bundled/runtime dependencies receive a final license and known-vulnerability review. | Complete; see [`dependency-audit.md`](dependency-audit.md). |
...
1. Complete the release checklist against the release commit.
